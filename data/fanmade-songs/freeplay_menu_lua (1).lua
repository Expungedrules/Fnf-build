...
function onCreatePost()
    ...
    addSong('cheating-b', 'play tutorial on easy', '9271fd', true)
    addSong('cheating-b', 'play tutorial on normal', '9271fd', true)
    addSong('cheating-b', 'play tutorial on hard', '9271fd', true)
    addSong('cheating-b', '1 easy 2 normal 3 hard', '9271fd', true)
    addSong('cheating-b', '1 press 7 on supernovae', '9271fd', true)
    addSong('cheating-b', '2 press 7 on glitch', '9271fd', true)
    addSong('cheating-b', '3 press 7 on dave thanksgiving', '9271fd', true)
    addSong('cheating-b', 'press 7 on cheating', '9271fd', true)
    addSong('cheating-b', 'press 7 on opposition', '9271fd', true)
    addSong('cheating-b', 'press 7 on therachy', '9271fd', true)
    addSong('cheating-b', 'press 7 on tsukareta', '9271fd', true)
...
function addSong(name, displayName, icon, color, unlocked, customFont)
    ...
    makeLuaText('display'..id, dnFinal, -1, 300, (150 * id))
