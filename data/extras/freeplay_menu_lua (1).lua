...
function onCreate()
    makeLuaSprite('bg', 'menuAwesom', 0, 0)
...
function onCreatePost()
    ...
    addSong('bonus-song', 'Bonus Song', 'dave-pixel', '9271fd', true)
    addSong('rano', 'Rano', 'dave-pixel', '9271fd', true)
    addSong('warmup', 'Warmup', 'dave-pixel', '9271fd', true)
    addSong('five-nights', 'Five Nights', 'dave-pixel', '9271fd', true)
    addSong('interdimensional', 'InterDimensional', 'dave-pixel', '9271fd', true)
    addSong('shredder', 'Shredder', 'bambi-3.0', '9271fd', true)
    addSong('screwed', 'Screwed', 'bambi-3.0', '9271fd', true)
    addSong('five-nights', 'Five Nights', 'dave-pixel', '9271fd', true)
    addSong('greetings', 'Greetings', 'tristan', '9271fd', true)
    addSong('bf-ugh', 'Bf Ugh', 'tristan', '9271fd', true)
