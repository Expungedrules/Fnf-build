...
function onCreatePost()
    ...
    addSong('Opposition', 'Opposition', 'OppoExpunged', '9271fd', true)
    addSong('Thearchy', 'Thearchy', 'ThearExpunged', '9271fd', true)
    addSong('Tsukareta', 'Tsukareta', 'tsukareta', '9271fd', true)
    addSong('Pessimistic', 'Pessimistic', 'OppoExpunged', '9271fd', true)
    addSong('Hellbreaker', 'Hellbreaker', 'OppoExpunged', '9271fd', true)
    addSong('Taimuresu', 'Taimuresu', 'OppoExpunged', '9271fd', true)
    addSong('Exploitation', 'Exploitation', 'true-expunged', '9271fd', true)
    addSong('Extrance', 'Extrance', 'true-expunged', '9271fd', true)
    addSong('Dethroned', 'Dethroned', 'true-expunged', '9271fd', true)
