...
function onCreate()
    makeLuaSprite('bg', 'banu', 0, 0)
    addLuaSprite('bg', false)
    addGlitchEffect('bg',2,20,0.2,100)
...
function onCreatePost()
    ...
    addSong('supernovae', 'SuperNovae', 'bambi-3.0', '9271fd', true)
    addSong('glitch', 'Glitch', 'bambi-3.0', '9271fd', true)
    addSong('vs-dave-thanksgiving', 'VS Dave ThanksGiving', 'bambi-3.0', '9271fd', true)
    addSong('cheating', 'Cheating', 'bambi_3d', '9271fd', true)
    addSong('unfairness', 'Unfairness', 'unfair', '9271fd', true)
    addSong('Opression', 'Opression', 'bambi-3d', '9271fd', true)
    addSong('kabunga', 'Kabunga', 'face', '9271fd', true)
